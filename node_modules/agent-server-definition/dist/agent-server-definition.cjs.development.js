...
var esbuild = _interopDefault(require('esbuild'));
...
var getHostNameFromUrl = function getHostNameFromUrl(url$1) {
  try {
    if (url$1.startsWith("http://") || url$1.startsWith("https://")) {
      var _urlObj = new url.URL(url$1);
      return _urlObj.hostname;
    }
    var urlObj = new url.URL("http://" + url$1);
    return urlObj.hostname;
  } catch (e) {
    try {
      var normalizedUrl = url$1;
      ...
      instance.interceptors.request.use(function (config) {
        try {
          ...
          if (config.url) {
            ...
            var fullUrl = config.url.startsWith("http") ? new url.URL(config.url) : new url.URL(config.url, config.baseURL || undefined);
    ...
    if (typeof originalFetch === "function") {
      global.fetch = /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(input, init) {
          var url$1, urlObj, payload, result;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                url$1 = typeof input === "string" ? input : input instanceof url.URL ? input.toString() : input.url;
                urlObj = new url.URL(url$1);
...
exports.setupRequestMiddleware = setupRequestMiddleware;
exports.startServer = startServer;
exports.utils = index$1;
//# sourceMappingURL=agent-server-definition.cjs.development.js.map
